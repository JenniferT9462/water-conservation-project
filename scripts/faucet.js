...
// // Event for when the glass bottle is clicked
// const glassBottle = document.getElementById("glass-bottle");
...
// // Event for when plastic bottle  is clicked
...
// // Event for when the faucet is clicked
...
function selectGlass() {
  ...
  // Move glass bottle into the bottle-zone
  const bottleZone = document.getElementById("bottle-zone");
  bottleZone.appendChild(glassBottle);

  glassBottle.style.position = "absolute";
  glassBottle.style.bottom = "75%";
  ...
  droplets.hidden = false;
  droplets.style.bottom = "-30px"; // Adjust this value to align droplets under the faucet
  droplets.style.left = "44%";
...
function clickFaucet() {
  ...
  if (glassSelected) {
    ...
    droplets.style.top = "-100px"; // Adjust this value to drop the water into the bottle
